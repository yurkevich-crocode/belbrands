      ...
      <div class="dashboard__wrapper">
        <div class="dashboard__items">
          ...
          <div class="dashboard__list-items">
            <a href="/brands.php" class="dashboard__list-item dashboard__list-item--active"
            ...
            ><a href="/category.php" class="dashboard__list-item"
              ...
              >Категории </a
            ><a href="/users.php" class="dashboard__list-item dashboard__list-item"
              ><span class="dashboard__icon-item"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
        ...
        <div class="container">
          ...
          <div class="brands__wrapper">
            <div class="brands__items">
              ...
              <div class="brands__item">
                ...
                <div class="brands__item-img-wrapper"><img src="<?=$brand[4]?>" class="brands__item-img" /></div>
                <div class="brands__item-wrapper">
                  <p class="brands__name"><?=$brand[1]?></p>
                  <div class="brands__control-wrapper">
                    <span class="brands__control-btn btn-edit"
                    data-id="<?=$brand[0]?>" 
                    data-name='<?=$brand[1]?>'
                    data-history="<?=$brand[3]?>"
                    data-date="<?=$brand[2]?>"
                    data-img="<?=$brand[4]?>"
          ...
          <div class="brands__info">
            <div class="brands__info-wrapper">
              ...
              <form class="brands__form-inputs" action="php/updateBrand.php" method="post" enctype="multipart/form-data">
              <input type="hidden" name="idBrand" id="idBrand">
                <div class="brands__form-input-wrapper">
                  ...
                  <div class="brands__detail-img-wrapper">
                    <img src="../../img/2.jpeg" alt="" id="imagePreviewEdit" class="brands__detail-img" />
                    <label for="editFile" class="brands__form-image-label"></label>
                    <input type="file" name="editFile" id="editFile" accept=".png,.jpg,.jpeg,.svg,.webp"   />
                  </div>
                </div>
                <div class="brands__form-input-wrapper">
                ...
                <div class="brands__form-input-wrapper">
                  ...
                  <input type="date" name="dateEdit" id="dateEdit" value="<??>"  min="2001-04-20" max="<?=$currentDate?>" class="brands__form-input" required/>
                </div>
                <div class="brands__form-input-wrapper">
                  <span class="brands__form-input-label">История:</span>
                  <textarea name="historyEdit" id="historyEdit" cols="30" rows="20" class="brands__form-input" required></textarea>
                </div>
          ...
          <div class="brands__info-add">
            <div class="brands__info-wrapper">
              ...
              <form class="brands__form-inputs" action="php/addBrand.php" method="post" enctype="multipart/form-data">
                <div class="brands__form-input-wrapper">
                  <span class="brands__form-input-label">Изображение:</span>
                  <div class="brands__detail-img-wrapper">
                    <img src="" alt="" class="brands__detail-img" id="imagePreviewAdd"/>
                    <label for="fileIMG" class="brands__form-image-label"></label>
                    <input type="file" name="fileIMG" id="fileIMG" accept=".png,.jpg,.jpeg,.svg,.webp" required/>
                  </div>
                </div>
                <div class="brands__form-input-wrapper">
                  <span class="brands__form-input-label">Наименование бренда:</span>
                  <input name="name" id="name" placeholder="Наименование бренда" class="brands__form-input" required/>
                </div>
                <div class="brands__form-input-wrapper">
                  <span class="brands__form-input-label">Категория бренда:</span>
                ...
                <div class="brands__form-input-wrapper">
                  <span class="brands__form-input-label">Дата основания:</span>
                  <input type="date" name="date" id="date"  min="2001-04-20" max="<?=$currentDate?>" class="brands__form-input" required/>
                </div>
                <div class="brands__form-input-wrapper">
                  <span class="brands__form-input-label">История:</span>
                  <textarea name="history" id="history" cols="30" rows="20" class="brands__form-input" required></textarea>
                </div>
