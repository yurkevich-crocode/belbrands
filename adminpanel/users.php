                ...
                <div class="dashboard__list-items">
                    <a href="/adminpanel/brands.php" class="dashboard__list-item"><span
                        ...
                        class="dashboard__list-item  dashboard__list-item--active"><span
                            class="dashboard__icon-item"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="26"
                                viewBox="0 0 50 50" class="dashboard__icon" fill="#828282">
            ...
            <div class="container">
                <div class="users__title-wrapper">
                    ...
                    <div class="searchbar__wrapper">
                        <input name="search" id="search" class="searchbar__input"
              ...
              ?>
                ...
                <div class="users__info">
                    <div class="users__info-wrapper">
                        ...
                        <form class="users__form-inputs" action="php/updateUser.php" method="post"
                            ...
                            <div class="users__form-input-wrapper">
                                ...
                                <input type="email" name="userEmail" id="userEmail" class="users__form-input"
                                    required />
                            </div>
                            <div class="users__form-input-wrapper">
                                <span class="users__form-input-label">Пароль:</span>
                                <input type="current-password" name="userPass" id="userPass" class="users__form-input"
                                    required />
                            </div>
                            <div class="users__form-input-wrapper">
