        ...
        <div class="dashboard__wrapper">
            <div class="dashboard__items">
                ...
                <div class="dashboard__list-items">
                    <a href="/adminpanel/brands.php" class="dashboard__list-item"><span
                        ...
                        class="dashboard__list-item dashboard__list-item--active"><span
                            class="dashboard__icon-item"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                class="dashboard__icon" height="26" viewBox="0 0 24 26" fill="#828282">
                                <path
            ...
            <a href="index.php" class="dashboard__list-item dashboard__list-item--log"><span
              ...
              ?>
                    ...
                    <div class="categories__info">
                        <div class="categories__info-wrapper">
                            ...
                            <form class="categories__form-inputs" action="php/updateCategory.php" method="post"
                                ...
                                <div class="categories__form-input-wrapper">
                                    ...
                                    <div class="categories__detail-img-wrapper">
                                        <img src="../../img/2.jpeg" alt="" class="categories__detail-img"
                                            id="imagePreviewEditCategory" />
                                        <label for="fileEdit" class="categories__form-image-label"></label>
                                        <input type="file" name="fileEdit" id="fileEdit" class="categories__form-image"
                                            accept=".png,.jpg,.jpeg,.svg,.webp" required />
                                    </div>
                                </div>
                                <div class="categories__form-input-wrapper">
                    ...
                    <div class="categories__info-add">
                        <div class="categories__info-wrapper">
                            ...
                            <form class="categories__form-inputs" action="php/addCategory.php" method="post"
                                enctype="multipart/form-data">
                                <div class="categories__form-input-wrapper">
                                    <span class="categories__form-input-label">Изображение:</span>
                                    <div class="categories__detail-img-wrapper">
                                        <img src="" alt="" class="categories__detail-img"
                                            id="imagePreviewAddCategory" />
                                        <label for="fileAdd" class="categories__form-image-label"></label>
                                        <input type="file" name="fileAdd" id="fileAdd" class="categories__form-image"
                                            accept=".png,.jpg,.jpeg,.svg,.webp" required />
                                    </div>
                                </div>
                                <div class="categories__form-input-wrapper">
                                    <span class="categories__form-input-label">Наименование категории:</span>
                                    <input name="nameAdd" id="nameAdd" placeholder="Наименование категории"
