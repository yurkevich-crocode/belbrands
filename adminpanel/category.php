<?php
require_once("php/getDataCategory.php");
session_start();
    ...
    <div class="dashboard">
      <div class="dashboard__wrapper">
        <div class="dashboard__items">
          <a href="#" class="dashboard__logotype"
            ><span class="dashboard__letter">Б</span> <span class="dashboard__word">ел</span>
            <span class="dashboard__letter">Б</span> <span class="dashboard__word">ренды</span></a
          >
          <div class="dashboard__list-items">
            <a href="/brands.php" class="dashboard__list-item"
              ><span class="dashboard__icon-item"
                ><svg
              ...
              >Бренды </a
            ><a href="/category.php" class="dashboard__list-item dashboard__list-item--active"
              ><span class="dashboard__icon-item"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
              ...
              >Категории </a
            ><a href="/users.php" class="dashboard__list-item"
              ><span class="dashboard__icon-item"
                ><svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="25"
        ...
        <a href="index.php" class="dashboard__list-item dashboard__list-item--log"
          ><span class="dashboard__icon-item dashboard__list-item--log"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="31"
              height="31"
      ...
      <section class="categories">
        <div class="container">
          <div class="categories__title-wrapper">
            ...
            <button class="categories__add-btn">Добавить запись</button>
            <div class="searchbar__wrapper">
              <input name="search" id="search" class="searchbar__input" placeholder="Поиск по категориям" />
            </div>
          </div>
          <div class="categories__wrapper">
            <div class="categories__items">
              ...
              $categories = mysqli_fetch_all($categoriesList);


              foreach($categories as $category){
              ?>
              <div class="categories__item">
                <span class="categories__item-id"><?=$category[0]?></span>
                <div class="categories__item-img-wrapper">
                  <img src="<?=$category[2]?>" class="categories__item-img" />
                </div>
                <div class="categories__item-wrapper">
                  <p class="categories__name"><?=$category[1]?></p>
                  <div class="categories__control-wrapper">
                    <span class="categories__control-btn btn-edit" data-id="<?=$category[0]?>" data-name="<?=$category[1]?>" data-img="<?=$category[2]?>"
                      ><img src="../../img/pencil.svg" alt="" class="categories__control-icon" /> </span
                    ><span class="categories__control-btn btn-delete"  data-id="<?=$category[0]?>" 
                      ><img src="../../img/trash.svg" alt="" class="categories__control-icon"
                    /></span>
                  </div>
                </div>
              </div>
            ...
            <div class="categories__info">
              <div class="categories__info-wrapper">
                <span class="categories__cross"></span>
                <form class="categories__form-inputs" action="php/updateCategory.php" method="post" enctype="multipart/form-data">
                  <input type="hidden" name="idEdit" id="idEdit">
                  <div class="categories__form-input-wrapper">
                    <span class="categories__form-input-label">Изображение:</span>
                    <div class="categories__detail-img-wrapper">
                      <img src="../../img/2.jpeg" alt="" class="categories__detail-img" id="imagePreviewEditCategory"/>
                      <label for="fileEdit" class="categories__form-image-label"></label>
                      <input type="file" name="fileEdit" id="fileEdit" class="categories__form-image" accept=".png,.jpg,.jpeg,.svg,.webp" required/>
                    </div>
                  </div>
                  <div class="categories__form-input-wrapper">
                    <span class="categories__form-input-label">Наименование категории:</span>
                    <input name="nameEdit" id="nameEdit" class="categories__form-input" />
                  </div>
                  <button type="submit" class="categories__btn">Сохранить изменения</button>
                </form>
              </div>
            </div>
            <div class="categories__info-add">
              <div class="categories__info-wrapper">
                <span class="categories__cross categories__cross-add"></span>
                <form class="categories__form-inputs" action="php/addCategory.php" method="post" enctype="multipart/form-data">
                  <div class="categories__form-input-wrapper">
                    <span class="categories__form-input-label">Изображение:</span>
                    <div class="categories__detail-img-wrapper">
                      <img src="" alt="" class="categories__detail-img" id="imagePreviewAddCategory"/>
                      <label for="fileAdd" class="categories__form-image-label"></label>
                      <input type="file" name="fileAdd" id="fileAdd" class="categories__form-image" accept=".png,.jpg,.jpeg,.svg,.webp" required/>
                    </div>
                  </div>
                  <div class="categories__form-input-wrapper">
                    <span class="categories__form-input-label">Наименование категории:</span>
                    <input name="nameAdd" id="nameAdd" placeholder="Наименование категории" class="categories__form-input" />
                  </div>
                  <button type="submit" class="categories__btn">Добавить запись</button>
                </form>
              </div>
            </div>
          </div>
